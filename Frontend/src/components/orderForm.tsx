...
const OrderForm: React.FC<OrderFormProps> =({ cartItems,totalPrice,onOrderSubmit  }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <span className={styles.totalHighlight}>Total : {`${totalPrice.toFixed(2)}`}</span>
          </div>
      </div>
        ...
        <div className={styles.field}>
          ...
          <select name="paymentMethod" value={formData.paymentMethod} onChange={handleChange} required>
            ...
            <button type="submit" className={styles.submitButton1} onClick={onOrderSubmit}>Enviar Orden</button>
